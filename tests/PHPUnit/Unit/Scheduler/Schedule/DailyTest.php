...
{
    private static $DT_JANUARY_01_1971_09_00_00;
    private static $DT_JANUARY_01_1971_09_10_00;
    private static $DT_JANUARY_01_1971_12_10_00;
    private static $DT_JANUARY_02_1971_00_00_00;
    private static $DT_JANUARY_02_1971_09_00_00;

    public static function setUpBeforeClass(): void
    {
        parent::setUpBeforeClass();
        self::$DT_JANUARY_01_1971_09_00_00 = mktime(9, 00, 00, 1, 1, 1971);
        self::$DT_JANUARY_01_1971_09_10_00 = mktime(9, 10, 00, 1, 1, 1971);
        self::$DT_JANUARY_01_1971_12_10_00 = mktime(12, 10, 00, 1, 1, 1971);
        self::$DT_JANUARY_02_1971_00_00_00 = mktime(0, 00, 00, 1, 2, 1971);
        self::$DT_JANUARY_02_1971_09_00_00 = mktime(9, 00, 00, 1, 2, 1971);
    }
    ...
    public function testGetRescheduledTimeDailyUnspecifiedHour()
    {
         ...
         */
        $mock = $this->getDailyMock(self::$DT_JANUARY_01_1971_09_10_00);
        $this->assertEquals(self::$DT_JANUARY_02_1971_00_00_00, $mock->getRescheduledTime());
    }
    ...
    public function test_setTimezone_ShouldConvertRescheduledTime()
    {
        ...
        $this->assertEquals(self::$DT_JANUARY_02_1971_00_00_00, $timeUTC);
    ...
    public function testGetRescheduledTimeDailySpecifiedHour()
    {
         ...
         */
        $mock = $this->getDailyMock(self::$DT_JANUARY_01_1971_09_00_00);
        $mock->setHour(9);
        $this->assertEquals(self::$DT_JANUARY_02_1971_09_00_00, $mock->getRescheduledTime());
        ...
        $mock = $this->getDailyMock(self::$DT_JANUARY_01_1971_12_10_00);
        $mock->setHour(9);
        $this->assertEquals(self::$DT_JANUARY_02_1971_09_00_00, $mock->getRescheduledTime());
